...
function create_else_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "class", div2_class_value = "drop" + (/*drag*/ ctx[1] ? " active" : "") + " svelte-g56pq5");
			attr(div3, "class", "or svelte-g56pq5");
			attr(input, "type", "file");
			input.multiple = "multiple";
			attr(input, "aria-label", "File browser");
			attr(input, "class", "svelte-g56pq5");
			attr(span, "class", "file-custom svelte-g56pq5");
			attr(label, "class", "file svelte-g56pq5");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*drag*/ 2 && div2_class_value !== (div2_class_value = "drop" + (/*drag*/ ctx[1] ? " active" : "") + " svelte-g56pq5")) {
...
function create_default_slot(ctx) {
	...
	function button_mediaList_binding(value) {
		/*button_mediaList_binding*/ ctx[10](value);
	}
	...
	if (/*mediaList*/ ctx[0] !== void 0) {
		button_props.mediaList = /*mediaList*/ ctx[0];
	}

	button = new Button({ props: button_props });
	binding_callbacks.push(() => bind(button, "mediaList", button_mediaList_binding));
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!updating_mediaList && dirty & /*mediaList*/ 1) {
				...
				button_changes.mediaList = /*mediaList*/ ctx[0];
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "upload-wrapper svelte-g56pq5");
		},
		m(target, anchor) {
